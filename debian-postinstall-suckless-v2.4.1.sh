...
# =============================================================================
# NIRUCON Debian 13 dwm Postinstall v2.4.1
# =============================================================================
#
# Target:
#   Debian 13 / Trixie
...
print_header() {
  ...
  echo
  echo "============================================================"
  echo "  NIRUCON Debian 13 dwm Postinstall v2.4.1"
  echo "============================================================"
  echo
...
EOF
  ...
  chmod +x "$LOCAL_BIN/audio-performance.sh" "$LOCAL_BIN/audio-balanced.sh" "$LOCAL_BIN/audio-status.sh" "$LOCAL_BIN/reaper-audio-check.sh" "$LOCAL_BIN/yabridge-sync.sh" "$LOCAL_BIN/umc1820-init.sh"
...
echo "  Recommended first test: run audio-status.sh. For UMC1820, set Reaper audio system to ALSA and choose hw:UMC1820."
echo
ok "Done."
